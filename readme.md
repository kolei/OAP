...
Консольный ввод/вывод. Функции и их параметры. 

+ [Лекция 4](/articles/t3l3.md)<br/>
Pair, Triple, Map. Методы основных типов данных.

+ [Лекция 4 (продолжение)](/articles/t3l4.md)<br/>
Циклы. Массивы. Коллекции. Множества (Set).

+ [Лекция 5](/articles/t3l5.md)<br/>
Кодировки символов: ASCII, UNICODE. Консольные программы.
