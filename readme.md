...
3. [Исключения. Null.](./articles/t5_exception.md)<!-- 2(22) -->
4. [Работа с файловой системой и файлами.](./articles/t5_files.md)<!-- 2(24) -->
5. [Многопоточность. Потоки, асинхронные вычисления](./articles/t5_thread_async.md)<!-- 2(26) -->
6. [Типы файлов: CSV, XML, JSON.](./articles/t5_file_types.md)<!-- 2(28) -->
7. [Регулярные выражения](./articles/t5_regex.md)<!-- 2(30) -->
...
2. [Ещё раз про классы. Интерфейсы.](./articles/t6_oop_habr.md)<!-- 2(36) -->
3. [LINQ](./articles/t6_linq.md)<!-- 2(36) -->
4. [Шаблоны проектирования.](./articles/t6_templates.md)<!-- 4(40) -->

**Лабораторные работы**

1. [ООП. Основы.](./articles/lab8-oop.md)
2. [ООП. Основы (продолжение)](./articles/lab8-oop2.md)
3. [ООП. Наследование.](./articles/lab8-oop3.md)<!-- 4(38) -->
4. [ООП. Интерфейсы.](./articles/lab8-oop4.md)<!-- 4(42) -->
