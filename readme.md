...
5. Объявление множества. Операции над множествами. Коллекции и последовательности. Работа с датами. Кортежи.
...
5. Работа с данными типа множество. Работа с коллекциями и последовательностями.
