...
4. [Каркас приложения. Модель данных. Привязка данных. Табличный вывод.](./articles/wpf_template.md)

5. [Фильтрация данных](./articles/wpf_filtering.md)
...
2. Создать набор данных для модели в заданном формате (CSV, XML, JSON) - 1 балл
3. Написать класс DataProvider, загружающий данные из файла с набором данных - 1,5 балл
4. Написать WPF-приложение 
  - вывести логотип компании - 0,5 балла
  - вывести таблицу с набором данных из поставщика данных - 1 балл
  - реализовать поиск по тесктовому полю - 1 балл
...
5. Написать вменяемую пояснительную записку в README.MD - 1 балл  
