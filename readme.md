...
1. [Создание WPF-приложения, знакомство с вариантами компоновки.](./articles/lab_wpf_base.md)<!-- 2(46) -->

2. [Каркас приложения. Модель данных. Привязка данных.](./articles/lab_wpf_binding.md)<!-- 2(48) -->

3. [Исследование визуальных компонентов WPF.](./articles/lab_wpf_elements.md)<!-- 4(52) -->
