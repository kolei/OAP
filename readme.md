...
4. [Каркас приложения. Модель данных. Привязка данных. Табличный вывод.](./articles/wpf_template.md)<!-- 4(54) -->

5. [Фильтрация данных](./articles/wpf_filtering.md)<!-- 2(56) -->

6. [Поиск, сортировка](./articles/wpf_search_sort.md)<!-- 2(58) -->

7. Создание WPF-приложений по индивидуальным заданиям (подготовка к экзамену)<!-- 8(66) -->

**Лабораторные работы**

1. [Создание WPF-приложения, знакомство с вариантами компоновки.](./articles/lab_wpf_base.md)<!-- 4(48) -->

2. [Каркас приложения. Модель данных. Привязка данных.](./articles/lab_wpf_binding.md)<!-- 4(52) -->

3. [Исследование визуальных компонентов WPF.](./articles/lab_wpf_elements.md)<!-- 4(56) -->

4. Создание WPF-приложений по индивидуальным заданиям (подготовка к экзамену)<!-- 14(70) -->

# ЭКЗАМЕН


1. Создать модель (класс) по заданной предметной области. Обязательно использовать типы: целое, вещественное, дата, строка. Одно из полей должно быть словарным - 1 балл
2. Создать набор данных (10 записей) для модели в заданном формате (CSV, XML, JSON) - 1 балл
3. Написать класс DataProvider, загружающий данные из файла с набором данных - 1,5 балла
4. Написать WPF-приложение 
  - вывести логотип компании - 0,5 балла
  - вывести таблицу с набором данных из поставщика данных - 1 балл
  - реализовать поиск по текcтовому полю - 1 балл
  - сделать сортировку по числовому полю - 1 балл
  - сделать фильтрацию по словарному полю - 1 балл
  - реализовать INotiftPropertyChanged - 0.5 балла
5. Написать вменяемую пояснительную записку в README.MD (обязательно использование кусков кода и скриншотов) - 1 балл  
6. Опубликовать в репозитории - 0,5 балла

>Предметная область и формат данных определяются перед экзаменом генератором случайных чисел

Итого 10 баллов (2, 4, 7)
