...
* для группы И-21 на примере языка Котлин (основной вариант)
* для группы И-21 на примере языка Питон (устаревший вариант)
* для группы С-21 на примере языка Питон (урощенный вариант)
