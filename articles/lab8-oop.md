...
Разработать классы для описанных ниже объектов. Сформировать наборы данных и реализовать выборку данных с помощью LINQ-запросов. 

Список полей и выборок приведён примерный - во всех заданиях должны быть реализованы свойства с типами **int**, **double**, **data**, **string** и выборки с использованием этих свойств.

Если работу с CSV ещё не проходили, то сформировать список исходных данных программно, например:
